...
object MethodRecordUtil {
    fun getParameterTypeList(descriptor: String): List<String> {
        System.out.println("lcyy getParameterTypeList")
    ...
    fun onMethodEnter(
        ...
        mv.visitVarInsn(AdviceAdapter.ALOAD, parametersIdentifier)
        mv.visitMethodInsn(
            AdviceAdapter.INVOKESTATIC, "com/lcy/gradleplugin/MethodRecorder", "onMethodEnter",
    ...
    fun onMethodExit(
        ...
        mv.visitMethodInsn(
            AdviceAdapter.INVOKESTATIC,
            "com/lcy/gradleplugin/MethodRecorder",
            "onMethodExit",
